...
<body style="color: rgb(19,24,30);background: linear-gradient(68deg, #634100 13%, rgb(183,124,37) 51%, #634100 84%), rgba(255,255,255,0.21);height: 850px;">
    ...
    <div style="height: 95%;display: inline-flex;width: 100%;margin: 0px;margin-top: 30px;">
        <div style="height: 98%;width: 50%;margin-top: 51px;">
            ...
            <form style="height: 79%;margin: 0px;margin-left: 20%;width: 60%;padding-left: 15px;border-radius: 35px;border-style: solid;border-color: rgb(204,204,204);" method="post" action="/customer">
                ...
                <div class="input-group" style="display: block;"><span class="input-group-text" style="margin-top: 15px;width: 50%;border-radius: 67px 0px 0px 6px;margin-left: 14px;padding-left: 35px;">Limite de crédito</span><input class="form-control" type="text" style="width: 95%;border-radius: 35px;border-width: 0px;" name="email"></div>
        ...
        <div style="height: 100%;width: 70%;">
            ...
            <div class="text-center" style="width: 1015px;margin-left: 60px;margin-top: -11px;">
                <h3>Filtros</h3><input type="text" style="margin-right: 15px;" placeholder="ID" name="filterId"><input type="text" style="margin-right: 15px;" name="filterName" placeholder="Nome"><input type="text" style="margin-right: 15px;" name="filterCity" placeholder="Cidade"><input type="text" style="margin-right: 15px;" name="filterCpf" placeholder="CPF"><input type="checkbox" name="filterEnable" style="height: 17px;"><span style="padding-left: 7px;font-size: 25px;">Ativo</span><button class="btn btn-primary" type="button" style="margin-left: 30px;">Imprimir</button>
            </div>
